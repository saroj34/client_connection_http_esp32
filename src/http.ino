...
#define gpio14LEDpin 14
const char* ssid = "asus_fbnpa_2.4"; /* Add your router's SSID */
const char* password = "CLFBC6E9D8"; /*Add the routerpassword */
    ...
    if (client.available())
    {
      ...
      if (c == '\n' && currentLineIsBlank)
      {
        ...
        */
        ...
        if (request.indexOf("/GPIO14ON") != -1) 
        {
          Serial.println("GPIO14 LED is ON");
          digitalWrite(gpio14LEDpin, HIGH);
          gpio14Value = HIGH;
        } 
        if (request.indexOf("/GPIO14OFF") != -1)
        {
          Serial.println("GPIO14 LED is OFF");
          digitalWrite(gpio14LEDpin, LOW);
          gpio14Value = LOW;
        }
        ...
        client.println("<h2>Welcome to ESP32 Web Server</h2>");
        ...
        if(gpio14Value == LOW) 
        {
          client.println("<p>GPIO14 LED Status: OFF</p>");
          client.print("<p><a href=\"/GPIO14ON\"><button class=\"button button3\">Click to turn ON</button></a></p>");  
        } 
        else 
        {
          client.println("<p>GPIO14 LED Status: ON</p>");
          client.print("<p><a href=\"/GPIO14OFF\"><button class=\"button button3\">Click to turn OFF</button></a></p>");  
        }
